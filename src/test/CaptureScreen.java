...
public class CaptureScreen extends JWindow implements ActionListener {
    ...
    private void doStart(){
        try{
            ...
            Temp temp=new Temp(jf,bi,di.width-6,di.height-6); // 自定义的Temp类的对象
    ...
    */
    ...
    private class PicPanel extends JPanel implements ActionListener{
        ...
        private void initPanel(){
            ...
            imageView.setImage(new Image(getImageStream()));
    ...
    private class Temp extends JPanel implements MouseListener,MouseMotionListener{
        ...
        public void paintComponent(Graphics g){
            ...
            if(showTip){
                ...
                g.fillRect(p.x+2,p.y+2,170,20);
                g.setColor(Color.RED);
                g.drawRect(p.x+2,p.y+2,170,20);
        ...
        public void mouseReleased(MouseEvent me){
            ...
            //鼠标松开时，显示操作窗口
            if(tools==null){
             tools=new ToolsWindow(CaptureScreen.this,me.getX(),me.getY());
            }else{
             tools.setLocation(me.getX(),me.getY());
            }
    ...
    {
     private CaptureScreen parent;

     public ToolsWindow(CaptureScreen captureScreen,int x,int y) {
     ...
     private void init(){
      ...
      //保存按钮
      JButton saveButton=new JButton(new ImageIcon(getClass().getResource("/test/save.png")));
      ...
      //关闭按钮
      JButton closeButton=new JButton(new ImageIcon(getClass().getResource("/test/delete.png")));
