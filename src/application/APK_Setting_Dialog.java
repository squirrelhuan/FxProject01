...
public class APK_Setting_Dialog extends Application {
	...
	public void start(Stage primaryStage) {
		try {
			Parent root = myResource.getApk_Setting_View();
	        ...
	        primaryStage.setTitle("Select Apk Path");  
	        primaryStage.show(); 
	...
	public static void setPrimaryStage(Stage primaryStage) {
		APK_Setting_Dialog.primaryStage = primaryStage;
	}
